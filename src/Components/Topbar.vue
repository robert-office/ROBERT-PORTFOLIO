<template>
  ...
  <header class="container mx-auto pt-4 flex gap-6 items-center h-10">
    ...
    <section class="flex items-center gap-6 h-6">
      ...
      <span class="bg-gray-400 font-bold h-full w-0.5"></span>
    </section>

    <section class="flex items-center gap-8 h-6">
